...
xz_rect::xz_rect() {}
xz_rect::xz_rect(double _x0, double _x1, double _z0, double _z1, double _k, const std::shared_ptr<material>& _mp) :
...
yz_rect::yz_rect() {}
yz_rect::yz_rect(double _y0, double _y1, double _z0, double _z1, double _k, const std::shared_ptr<material>& _mp) :
    y0(_y0), y1(_y1), z0(_z0), z1(_z1), k(_k), mp(_mp) {}

bool yz_rect::hit(const ray &r, double t_min, double t_may, hit_record &rec) const
{
    // Determine t where z == k
